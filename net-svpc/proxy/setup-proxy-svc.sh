...
command=socat TCP-LISTEN:6380,fork,reuseaddr TCP:10.61.12.5:6378
autostart=true
autorestart=true
...
echo "Testing Redis primary (10.61.12.4:6378 -> localhost:6379)..."
nc -zv 10.61.12.4 6378
nc -zv localhost 6379

echo "Testing Redis read (10.61.12.5:6378 -> localhost:6380)..."
nc -zv 10.61.12.5 6378  
nc -zv localhost 6380

echo ""
echo "Updated Redis proxy configuration:"
echo "- Redis Primary: localhost:6379 -> 10.61.12.4:6378"
echo "- Redis Read: localhost:6380 -> 10.61.12.5:6378"
echo "- PostgreSQL Primary: localhost:5432 -> 10.61.1.2:5432"
echo "- PostgreSQL Replica: localhost:5433 -> 10.61.2.3:5432"
